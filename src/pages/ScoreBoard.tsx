...
import Container71 from "../components/Container71";
import LeaderBoardSection from "../components/LeaderBoardSection";
import ContainerFrame1 from "../components/ContainerFrame1";
...
const ScoreBoard: FunctionComponent = () => {
  return (
    <div className="relative bg-white w-full h-[5418px] overflow-hidden text-left text-[1.97px] text-darkslategray-200 font-poppins">
      <img
        className="absolute top-[736px] left-[686px] w-[69px] h-[15px]"
        alt=""
        src="/group-1000008788.svg"
      />
      <DateFilterContainer />
      <Container71 />
      <div className="absolute top-[848px] left-[calc(50%_-_675px)] w-[1350px] h-[1095px]">
        ...
        <div className="absolute top-[1036px] left-[590px] w-[171px] h-[59px] text-lg text-black">
          ...
          <div className="absolute top-[20px] left-[39px] leading-[20px] font-medium">{`Load More `}</div>
        </div>
        ...
        <div className="absolute top-[345px] left-[calc(50%_+_439px)] w-[101px] h-[54.7px] text-center font-lato">
          <div className="absolute top-[0px] left-[calc(50%_-_50.5px)] w-[101px] h-[54.7px]">
            ...
            <div className="absolute top-[2px] left-[2.5px] w-[95.4px] h-[47.5px]">
              ...
              <div className="absolute top-[0px] left-[49.4px] w-[12.9px] h-[3px]">
                <div className="absolute top-[0.4px] left-[0px] rounded-[0.25px] bg-mediumseagreen w-0.5 h-0.5" />
          ...
          <div className="absolute top-[22.4px] left-[8.1px] w-[3.9px] h-[23.8px]">
            ...
            <div className="absolute top-[7.7px] left-[0px] rounded-t-[0.74px] rounded-b-none bg-mediumseagreen w-[3.9px] h-[16.1px]" />
          </div>
          <div className="absolute top-[14.6px] left-[15.4px] w-[3.9px] h-[31.6px]">
            ...
            <div className="absolute top-[10.3px] left-[0px] rounded-t-[0.74px] rounded-b-none bg-mediumseagreen w-[3.9px] h-[21.3px]" />
          </div>
          <div className="absolute top-[35.3px] left-[22.6px] w-[3.9px] h-[10.9px]">
            ...
            <div className="absolute top-[3.6px] left-[0px] rounded-t-[0.74px] rounded-b-none bg-mediumseagreen w-[3.9px] h-[7.4px]" />
          </div>
          <div className="absolute top-[10.2px] left-[29.9px] w-[3.9px] h-9">
            ...
            <div className="absolute top-[11.7px] left-[0px] rounded-t-[0.74px] rounded-b-none bg-mediumseagreen w-[3.9px] h-[24.3px]" />
          </div>
          <div className="absolute top-[29.9px] left-[37.1px] w-[3.9px] h-[16.3px]">
            ...
            <div className="absolute top-[5.3px] left-[0px] rounded-t-[0.74px] rounded-b-none bg-mediumseagreen w-[3.9px] h-[11px]" />
          </div>
          <div className="absolute top-[37.6px] left-[44.4px] w-[3.9px] h-[8.6px]">
            ...
            <div className="absolute top-[2.8px] left-[0px] rounded-t-[0.74px] rounded-b-none bg-mediumseagreen w-[3.9px] h-[5.8px]" />
          </div>
          <div className="absolute top-[24.8px] left-[51.6px] w-[3.9px] h-[21.4px]">
            ...
            <div className="absolute top-[6.9px] left-[0px] rounded-t-[0.74px] rounded-b-none bg-mediumseagreen w-[3.9px] h-[14.4px]" />
          </div>
          <div className="absolute top-[13.5px] left-[58.9px] w-[3.9px] h-[32.7px]">
            ...
            <div className="absolute top-[10.6px] left-[0px] rounded-t-[0.74px] rounded-b-none bg-mediumseagreen w-[3.9px] h-[22.1px]" />
          </div>
          ...
          <div className="absolute top-[26.4px] left-[73.4px] w-[3.9px] h-[19.8px]">
            ...
            <div className="absolute top-[11.7px] left-[0px] rounded-t-[0.74px] rounded-b-none bg-mediumseagreen w-[3.9px] h-[8.1px]" />
          </div>
          <div className="absolute top-[16.3px] left-[80.6px] w-[3.9px] h-[29.9px]">
            ...
            <div className="absolute top-[9.7px] left-[0px] rounded-t-[0.74px] rounded-b-none bg-mediumseagreen w-[3.9px] h-[20.2px]" />
          </div>
          <div className="absolute top-[36.6px] left-[87.9px] w-[3.9px] h-[9.6px]">
            ...
            <div className="absolute top-[3.1px] left-[0px] rounded-t-[0.74px] rounded-b-none bg-mediumseagreen w-[3.9px] h-[6.5px]" />
          </div>
          <div className="absolute top-[31.7px] left-[95.1px] w-[3.9px] h-[14.5px]">
            ...
            <div className="absolute top-[4.7px] left-[0px] rounded-t-[0.74px] rounded-b-none bg-mediumseagreen w-[3.9px] h-[9.8px]" />
          </div>
        </div>
      ...
      {/* <div className="absolute top-[2976px] left-[45px] w-[1350px] h-[1470px] text-17xl text-darkslateblue">
        <div className="absolute top-[785px] left-[0px] w-[1350px] h-[685px]">
            ...
            <div className="absolute top-[0px] left-[0px] w-[596px] h-[103px]">
              <div className="absolute top-[2px] left-[0px] w-[545px] h-[71px]">
                <img
                  ...
                  alt=""
                  src="/ellipse-2300@2x.png"
                />
                <b className="absolute top-[36px] left-[48px] tracking-[0.04em] leading-[18px] [text-shadow:0px_7px_4px_#ccf2fe]">
          ...
          <div className="absolute top-[201px] left-[0px] w-[1350px] h-[484px] text-lg text-gray1-300">
            <div className="absolute top-[74px] left-[0px] w-[1350px] h-[410px]">
              ...
              <div className="absolute top-[0px] left-[0px] shadow-[0px_4px_10px_rgba(0,_0,_0,_0.25)] w-[1350px] h-[69px]">
                <div className="absolute top-[0px] left-[0px] rounded-10xs bg-pink shadow-[0px_4px_10px_rgba(0,_0,_0,_0.25)] w-[1350px] h-[69px]" />
              </div>
              ...
              <div className="absolute top-[170px] left-[0px] w-[1350px] h-[70px]">
                <div className="absolute top-[0px] left-[0px] rounded-10xs bg-lightgreen shadow-[0px_4px_10px_rgba(0,_0,_0,_0.25)] w-[1350px] h-[70px]" />
              </div>
              <div className="absolute top-[256px] left-[0px] w-[1350px] h-[69px]">
                <div className="absolute top-[0px] left-[0px] rounded-10xs bg-khaki shadow-[0px_4px_10px_rgba(0,_0,_0,_0.25)] w-[1350px] h-[69px]" />
              </div>
            </div>
        ...
        <div className="absolute top-[0px] left-[0px] w-[1350px] h-[685px]">
            ...
            <div className="absolute top-[0px] left-[0px] w-[526px] h-[103px]">
              <div className="absolute top-[2px] left-[0px] w-[486px] h-[73px]">
                <img
                  ...
                  src="/ellipse-2300@2x.png"
                />
                <b className="absolute top-[19px] left-[48px] tracking-[0.04em] [text-shadow:0px_7px_4px_#b8e4fd]">
