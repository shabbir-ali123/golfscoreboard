...
type ContainerComponent71Type = {
  /** Style props */
  groupDivLeft?: CSSProperties["left"];
};

const ContainerComponent71: FunctionComponent<ContainerComponent71Type> = ({
  groupDivLeft,
}) => {
        ...
        <div className="absolute top-[0px] left-[0px] w-[428px] h-[273.8px]">
            ...
            <div className="absolute top-[12.9px] left-[19.6px] w-[388.5px] h-[248.7px]">
              <div className="absolute top-[0px] left-[0px] w-[388.5px] h-[248.7px]">
                ...
                <div className="absolute top-[132.2px] left-[34.4px] w-[198.4px] h-[23px]">
                  <b className="absolute top-[5.4px] left-[0px] tracking-[1.92px] leading-[12.2px] inline-block w-[58.7px]">
                    Name :
                  </b>
                  <div className="absolute top-[5.4px] left-[92.4px] tracking-[1.92px] leading-[12.2px] font-semibold text-lightseagreen-200">
                    Rory McIlroy
                  </div>
                  <img
                ...
                <div className="absolute top-[176.2px] left-[29px] w-[140.3px] h-[33.9px] text-darkslategray-500">
                  <div className="absolute top-[0px] left-[0px] w-[140.3px] h-[33.9px]">
                    <div className="absolute top-[0px] left-[0px] w-[140.3px] h-[33.9px]">
                      <b className="absolute top-[10.8px] left-[0px] tracking-[1.92px] leading-[12.2px] inline-block w-[87.6px]">
                        Total Par :
                      </b>
                      <div className="absolute top-[0px] left-[102.5px] w-[37.8px] h-[33.9px] text-[27.11px] text-white">
                        <div className="absolute top-[0px] left-[0px] w-[37.8px] h-[33.9px]">
                          <div className="absolute top-[0px] left-[0px] w-[37.8px] h-[33.9px]">
                            ...
                            <b className="absolute top-[10.8px] left-[5.4px] tracking-[1.92px] leading-[12.2px] inline-block w-[26.9px]">
                              71
                            </b>
                          </div>
                        </div>
              ...
              <div className="absolute top-[34.5px] left-[187.5px] w-[155.8px] h-[84.6px] text-[5.34px] text-white font-body-b2">
                <div className="absolute top-[0px] left-[0px] w-[155.2px] h-[84.6px]">
                  ...
                  />
                  <div className="absolute top-[11.2px] left-[70.9px] text-[6.68px] tracking-[-0.04px] leading-[4.01px] uppercase font-semibold text-darkturquoise-200 flex items-center w-[70.7px] h-1 [-webkit-text-stroke:0.2px_#00eafe] [transform:_rotate(-3.97deg)] [transform-origin:0_0]">
                    Sarut Vongchaisit
                  </div>
                  ...
                  <div className="absolute top-[56.3px] left-[93.3px] w-[35px] h-3.5">
                    ...
                    <div className="absolute top-[0.7px] left-[21.1px] w-[13.3px] h-[13.4px] [transform:_rotate(-3.01deg)] [transform-origin:0_0] text-[8.02px]">
                      <div className="absolute top-[0px] left-[0px] w-[13.3px] h-[13.4px] [transform:_rotate(-3.01deg)] [transform-origin:0_0]">
                        <div className="absolute top-[0px] left-[0px] rounded-[0.67px] bg-crimson w-[13.3px] h-[13.4px] [transform:_rotate(-3.01deg)] [transform-origin:0_0]" />
          ...
          <div className="absolute top-[189.1px] left-[201px] w-[140.3px] h-[33.9px] text-darkslategray-500">
            <div className="absolute top-[10.8px] left-[0px] w-[91.6px] h-[13px]">
              <b className="absolute top-[0px] left-[0px] tracking-[1.92px] leading-[12.2px] inline-block w-[91.6px]">
                Score Par :
              </b>
            </div>
            <div className="absolute top-[0px] left-[102.5px] w-[37.8px] h-[33.9px] text-[27.11px] text-white">
              ...
              <b className="absolute top-[10.8px] left-[1.3px] tracking-[1.92px] leading-[12.2px] inline-block w-[34.8px]">
                78
              </b>
            </div>
          </div>
...
export default ContainerComponent71;
