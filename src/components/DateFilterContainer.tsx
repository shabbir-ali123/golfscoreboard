...
const DateFilterContainer: FunctionComponent = () => {
  return (
    <div className="absolute top-[78px] left-[calc(50%_-_605px)] w-[1210px] h-[171px] text-left text-xl text-darkslategray-300 font-body-b2">
      ...
      <div className="absolute top-[29px] left-[240px] w-[870px] h-[81px] text-21xl text-black">
        ...
        <div className="absolute h-[59.26%] w-[30.11%] top-[40.74%] right-[0%] bottom-[0%] left-[69.89%] text-5xl text-darkgray">
          <img
